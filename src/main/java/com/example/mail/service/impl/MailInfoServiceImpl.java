...
public class MailInfoServiceImpl implements MailInfoService {
     ...
     * @throws Exception
     */
    public void checkBaseMailInfo(MailInfoModel mailModel) throws Exception {
